 ...
 */
 function addTwoToArray(arr) {
  ...
  console.group(addTwo);
  console.log(addTwoToArray([1,3,4,5,6,7,78,8,8,9,10,11,12,13,14,15,16]));
 /*
 ...
 */
 ...
 function addThreeToArray(arr) {
  ...
  console.group(addThree);
  console.log(addThreeToArray([1,3,4,5,6,7,78,8,8,9,10,11,12,13,14,15,16]));
 /*
 ...
 */
 function changeArray(arr,parameter) {
   let addThree = []
   for(let i = 0; i < arr.length; i++){
     if(parameter === "addTwo"){
       addThree[i] = arr [i] + 2;
     } if( parameter === 'addThree'){
       addThree[i] = arr [i] + 3;
     }
     if( parameter === 'addFive'){
       addThree[i] = arr [i] + 5;
     }  
   }
  ...
  console.log(changeArray([1,3,4,5,6,7,78,8,8,9,10,11,12,13,14,15,16],"addFive"));
 ...
 */
 ...
 /*
  Create a function named `second`
   - Inside second create another function named `third` which 
   accepts a number, adds 1 to it and returns it
   - Return the function defination (third) from the second 
     function
   - Also write the required code to call the function
 */
    let second = function third(num){
   console.log(second)
    return num + 1;
  };
...
const people = [
 ...
 function deepCopy(sourceObject, grade) {
 
     for(key in sourceObject) {
         if(typeof sourceObject[key] != "object") {
             grade[key] = sourceObject[key];
         } else {
             grade[key] = {};
             deepCopy(sourceObject[key], grade[key]);
         }
     }
 }
 
 deepCopy(grades, grade);
...
//  let isMale = grades.filter(function (grade) {
//    return grade.sex === "M";
//  })
...
//  var isFemale = grades.filter(function (grade) {
//    return grade.sex === "F";
//  })
...
//  var isGradeA = grades.filter(function (grade) {
...
//  var isGradeB = grades.filter(function (grade) {
//    return grade.grade < 12 ;
//  })
...
//  var isGradeC = grades.filter(function (grade) {
 ...
 */
  ...
  var filterAdult = people.filter(function (people) {
 ...
 */
 var filterMale = grades.filter(function (grade) {
   return grade.sex === "M";
 })
 ...
 */
 ...
 var filterFemale = grades.filter(function (grade) {
   return grade.sex === "F";
 })
 ...
 */
 var filterGradeA = grades.filter(function (grade) {
   return grade.grade >= 12 ;
 })
 
 console.log(filterGradeA);
 ...
 */
 ...
 var filterGradeB = grades.filter(function (grade) {
   return grade.grade <=12 ;
 })
 
 console.log(filterGradeB);
